...
Meteor.publish("groupUsers", function(groupId) {
  ...
  return Meteor.users.find({_id: { $in: userIds }}, { fields: {'profile.headline': 1, 'profile.pictureUrl': 1, 'profile.firstName': 1, 'profile.lastName': 1, 'summary': 1, 'profile.publicProfileUrl': 1}});
});
